// screening.mjs — 保守自动初筛（@dsh-reliability/core）
// 本文件是对 sidecar/reliability/screening.mjs 的逐字镜像（vendored），保证评分规则与
// 已验收的侧车实现完全一致。任何规则变更必须两边同步；test/core-api.test.mjs 中的
// 一致性测试会守住这条边界。禁止在本文件内独立修改评分规则。
